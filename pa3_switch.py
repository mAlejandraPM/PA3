        ...
        for p in prots: 
            if p.ethertype == ether_types.ETH_TYPE_ARP:
                ...
                if robin_value%2 ==  1:
                	...
                	e = ethernet.ethernet(dst='00:00:00:00:00:01', src='00:00:00:00:00:02', ethertype=0x0800) #ether.ETH_TYPE_ARP)
                	a = arp.arp(hwtype=1, proto=0x0800, hlen=6, plen=4, opcode=2, src_mac='00:00:00:00:00:03', src_ip='10.0.0.4', dst_mac='00:00:00:00:00:05', dst_ip='10.0.0.6')
